    ...
    <head>
        ...
        <style>
            ...
            .sidebar a {
                ...
                width: 50px;
                padding: 15px 0;
                /* Aumenta o espaçamento entre os ícones */
                color: #FCEE09;
    ...
    <body>
        <!-- Navbar -->
        <nav class="navbar">
            <img style="width: 250px; margin-left: 50px; height: 90px" src="{{ asset('assets/logovortex.png') }}"
                class="logo" />
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide d-md-none" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <div class="action-card">
                                        <img src="{{ asset('assets/operating.jpg') }}"
                                            alt="Operating Image" />
                    ...
                    <div class="col-md-3 info-perfil">
                        <div class="profile-card">
                            ...
                            <div class="profile-details">
                                <div>
                                    <p style="background-color: rgb(58, 54, 54); border: solid rgb(58, 54, 54); border-radius: 10px; position: relative;"
                                        class="p-3">
                                        Status da Conta:
                                        <span
                                            style="background-color: rgba(0, 128, 0, 0.2); border: 2px solid rgba(0, 128, 0, 0.8); border-radius: 20px; padding: 10px 25px 10px 25px; color: white;">Ativo</span>
                                    </p>
                                </div>
                                <div>
                                    <p style="background-color: rgb(58, 54, 54); border: solid rgb(58, 54, 54); border-radius: 10px; position: relative;"
                                        ...
                                        <span
                                            style="background-color: rgba(75, 0, 130, 0.2); border: 2px solid rgba(75, 0, 130, 0.8); border-radius: 20px; padding: 10px 25px 10px 25px; color: white;">SMART</span>
                                    </p>
                                </div>

                                <hr class="divider" />
                                <div class="account-info">
                                    <p class="account-text bank-total"><i class="bi bi-bank2"></i></p>
                                    <p class="account-text dollar"><i class="bi bi-currency-dollar"></i></p>
                                </div>
